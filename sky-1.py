...
class Star(object):
    ...
    def distance_to(self, other):
        ...
        '''
        d2 = (self.__x-other.__x)**2 + (self.__y-other.__y)**2
        return d2**(1/2)
...
class Sky(object):
    ...
    def westernmost_star(self):
        ...
        value).'''
        result = self.__stars[0]
        for star in self.__stars:
            if result.getX()>star.getX():
                result = star
        return result
...
if __name__ == '__main__':
    ...
    print('Star 1\'s x-coordinate: %d' % star1.getX())
    print('Star 2\'s y-coordinate: %d' % star2.getY())
